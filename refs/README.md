...
| `min_W`, `max_W` | **Instead of** `expected_W`,`tol_pct` — for manuals that say "17–25 W" (easier to type into an Excel template). Same band either way; the wizard opens either and saves back in the form it opened. |
